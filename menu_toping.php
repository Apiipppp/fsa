  ...
  <!-- Menu -->
      <div class="container">
        <div class="row mt-3">
          ...
          $query = mysqli_query($koneksi, 'SELECT * FROM toping');
          ...
          <div class="col-md-3 mt-4">
            <div class="card brder-dark">
              ...
              <div class="card-body">
                <h5 class="card-title font-weight-bold"><?php echo $result['nama_toping'] ?></h5>
               <label class="card-text harga"><strong>Rp.</strong> <?php echo number_format($result['harga']); ?></label><br>
                <a href="beli_toping.php?id_toping=<?php echo $result['id_toping']; ?>" class="btn btn-success btn-sm btn-block ">BELI</a>
              </div>
            </div>
          </div>
          <?php endforeach; ?>
